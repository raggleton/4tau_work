...
// ./basicScript (uses the filename of this cpp as the program name)
//
// then in future do (yes it only re-makes if the cpp file has newer modification time, so stupid!)
// touch examples/basicScript.cpp && make && ./basicScript
//------------------------------------------------------------------------------

// Here you can put your analysis macro   

#include "basicScript.C"

//------------------------------------------------------------------------------

int main(int argc, char *argv[])
{
	char *appName = "basicScript";
