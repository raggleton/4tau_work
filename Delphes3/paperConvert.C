...
void combineHists( TFile* fSig, TFile* fBg, std::string histName, std::string plotOpt, std::string outputName){
    ...
    leg.SetFillColor(kWhite);
    leg.SetLineColor(kWhite);
    leg.AddEntry(hSig,"#splitline{Signal MC}{h (125 GeV) #rightarrow 2#phi (8 GeV) #rightarrow 4#tau}","l");
...
void paperConvert() {
    ...
    l.AddEntry(hM_bare_sig_muRand_HLT_dR2, "#splitline{Signal MC}{h (125 GeV) #rightarrow 2#phi (8 GeV) #rightarrow 4#tau}", "lp");
    ...
    TLegend l(0.5,0.72, 0.85,0.88);
    l.AddEntry(hM_side_1to2p5_sig, "#splitline{Signal MC}{h (125 GeV) #rightarrow 2#phi (8 GeV) #rightarrow 4#tau}", "lp");
    ...
    // track distributions
    combineHists(f_sig_main, f_bg_main, "hNTracksAbs1", "HISTE", "combined_NTrackAbs1_muRand.pdf");
    combineHists(f_sig_main, f_bg_main, "hNTracksAllAbs1", "HISTE", "combined_NTrackAllAbs1_muRand.pdf");
    combineHists(f_sig_main, f_bg_main, "hNTracksAll1", "HISTE", "combined_NTrackAll1_muRand.pdf");
    combineHists(f_sig_main, f_bg_main, "hNTracks1", "HISTE", "combined_NTrack1_muRand.pdf");
    combineHists(f_sig_main, f_bg_main, "hNSoftTracksAbs1", "HISTE", "combined_NSoftTrackAbs1_muRand.pdf");
    combineHists(f_sig_main, f_bg_main, "hNSoftTracks1", "HISTE", "combined_NSoftTrack1_muRand.pdf");
