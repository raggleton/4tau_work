...
// ./reweightingVariables (uses the filename of this cpp as the program name)
//
// then in future do (yes it only re-makes if the cpp file has newer modification time, so stupid!)
// touch examples/reweightingVariables.cpp && make && ./reweightingVariables
//------------------------------------------------------------------------------

// Here you can put your analysis macro   

#include "reweightingVariables.C"

//------------------------------------------------------------------------------

int main(int argc, char *argv[])
{
	char *appName = "reweightingVariables";
...
// Here you call your macro's main function 
	...
	reweightingVariables(argc,argv);
